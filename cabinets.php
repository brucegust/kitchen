...
class ProductPage {
	...
	$sql="select category, sub_category from categories where id='$_GET[category_id]'";
	//echo $sql;
		if(!$query=$cxn->query($sql))
		{
			$err='your course list didn\'t happen because: '
...
?>
		...
		{
		?>
		<div style="width:85%; height:auto; border:1px solid #cccccc; margin:auto; text-align:auto; box-shadow: 10px 10px 5px #cccccc; padding:10px;">If you've already selected a door and it's in your Shopping Cart, you can click on the door name below each product to proceed directly to the "features" page. In that way, you don't have to repeat the process of selecting the same door.</div>
		<?php
		}
				...
				<td style="text-align:center;">
					<table border="0" style="margin:auto;">
						...
						if (@$_SESSION['door'] == "1")                   
						{
							...
							?>
							<tr>
								<td style="text-align:left;">&#9679;&nbsp;<a href="door_shop.php?door_id=<?php echo $shopper['door_table_id'];?>&product_id=<?php echo $display['id'];?>" style="color:#000000;"><?php echo $shopper['doorname'];?></a></td>
							</tr>
							<?php
							}
						}
