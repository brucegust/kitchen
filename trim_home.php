...
class ProductPage {
	...
	$sql="select * from categories where macro_category_id='2'";
	//echo $sql;
...
?>
		<span class="satellite_title">Trim and Details</span><br><br>
		<?php
				...
				<td style="text-align:center;">
					<table border="0" style="margin:auto;">
						<tr>
							...
							?>
							<a href="trim.php?category_id=<?php echo $display['id'];?>"><img src="<?php echo $display['image_path']; ?>" border="0" alt="<?php echo $display['category']; ?>" style="width:<?php echo $new_size;?>px; vertical-align:middle;" border="0"></a>
							<?php
							}
							else
							{
							?>
							<a href="trim.php?category_id=<?php echo $display['id'];?>"><img src="images/no_image_available.jpg" border="0" style="width:200px;" border="0"></a>
							<?php
							}
							?>		
							</td>
