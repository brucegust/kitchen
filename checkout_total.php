...
<table class="subtotal" border="0">
	...
	<tr>
		...
		{
		?>
			<td colspan="3" class="subtotal_cell"><input type="checkbox" name="residential" value="Y" style="margin-top:3px;">&nbsp;add Residential Delivery ($<?php $res_price=current_shipping("392"); echo number_format($res_price, 2);?>)&nbsp;</td>
		<?php
		}
		else
		{
	...
	<tr>
		...
		{
		?>
		<td colspan="3" class="subtotal_cell"><input type="checkbox" name="liftgate" value="Y" style="margin-top:3px;">&nbsp;add Liftgate  Charge ($<?php $lift_price=current_shipping("393"); echo number_format($lift_price,2);?>)&nbsp;</td>
		<?php
		}
		else
		{
