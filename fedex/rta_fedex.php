...
require_once('fedex-common_rta.php');
...
$request['RequestedShipment']['PackageCount'] = '3';
$request['RequestedShipment']['RequestedPackageLineItems'] = addPackageLineItem1();
$request['RequestedShipment']['RequestedPackageLineItems'] = addPackageLineItem2();
$request['RequestedShipment']['RequestedPackageLineItems'] = addPackageLineItem3();
...
function addShipper(){
	$shipper = array(
		'Contact' => array(
			...
			'CompanyName' => 'RTA Kitchen Cabinets.com',
...
for($x=1; $x<=$package_count; $x++)
{
function addPackageLineItem{$x}(){
	$packageLineItem = array(
		'SequenceNumber'=>$x,
		'GroupPackageCount'=>$x,
		'Weight' => array(
