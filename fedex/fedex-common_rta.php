...
function writeToLog($client){  
	 ...
	 */
	if (!$logfile = fopen('fedextransactions.log', "a"))
	{
...
function getProperty($var){
	if($var == 'key') Return 'z3j4Q3aICNbguq4t'; 
	if($var == 'password') Return 'OTemrgiuNhIXCnKKTdRVZiMyZ'; 
	if($var == 'shipaccount') Return '435590241';
	if($var == 'billaccount') Return '435590241'; 
