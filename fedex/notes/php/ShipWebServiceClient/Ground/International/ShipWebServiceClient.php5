...
$request['TransactionDetail'] = array('CustomerTransactionId' => '*** Ground International Shipping Request v12 using PHP ***');
...
function addSpecialServices1(){
	$specialServices = array(
		...
		'CodDetail' => array(
			'CodCollectionAmount' => array('Currency' => 'USD', 'Amount' => 80),
