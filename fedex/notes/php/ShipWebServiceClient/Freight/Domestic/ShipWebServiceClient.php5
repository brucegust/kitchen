...
$request['TransactionDetail'] = array('CustomerTransactionId' => '*** Freight Domestic Shipping Request v12 using PHP ***');
...
try 
{
    ...
    if ($response->HighestSeverity != 'FAILURE' && $response->HighestSeverity != 'ERROR')
    {
        ...
        trackDetails($response->CompletedShipmentDetail->ShipmentRating, '');
		echo '</table>';
...
function addShipper(){
	$shipper = array(
		...
		'Address' => array(
			'StreetLines' => array('1 StreetLine'),
			'City' => 'Collierville',
