				...
				<td style="text-align:center;">
					<table border="0" style="margin:auto;">
						<tr>
							...
							?>
							<a href="cabinets.php?category_id=<?php echo $display['id'];?>"><img src="<?php echo $display['image_path']; ?>" border="0" alt="<?php echo $display['sub_category']; ?>" style="width:<?php echo $new_size;?>px; vertical-align:middle;" border="0"></a>
							<?php
							}
							else
							{
						...
						<tr>
							...
							<b><?php echo stripslashes($display['sub_category']); ?></b><br>
							</div><br>
							</td>
						</tr>
					</table>
