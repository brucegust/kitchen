...
<td class="MainText">
<P>
Below is the product you just selected that corresponds to the...<div style="margin:auto; text-align:center; font-weight:bold;"><?php echo $door_name;?></div><br>...door / cabinet color price. 
<P>
Change the price as it's documented below, then click on the "submit" button below.<br><br>
...
<td align="center">
		...
		<?php	
		$querystate = "select features.id as feature_table_id, features.product_id, features.part_number, features.featureprice, products.categories as product_category,products.category_id,  products.thumbnail as thumbnail from features INNER JOIN products on features.product_id = products.part_id where features.id='$_GET[feature_table_id]'";
		//echo $querystate;
		...
		<tr>
			...
			<td>
				<input type="text" style="width:95%;" name="featureprice" value="<?php echo $row['featureprice'];?>">
			</td>
		</tr>
		</table>
	</td>
...
<tr>
	<td style="text-align:center"><br><input type="hidden" name="feature_id" value="<?php echo $_GET['feature_id'];?>"><input type="hidden" name="category_id" value="<?php echo $_GET['category_id'];?>"><input type="hidden" name="product_id" value="<?php echo $_GET['product_id'];?>"><input type="hidden" name="feature_table_id" value="<?php echo $row['feature_table_id'];?>"><input type="submit" value="submit"></td>
</tr>
</table>
