...
{
$ID=$_GET[ID];
header("Location: door_delete.php?ID=$ID");
}
else
{
...
<script>
function big_page() {   
	if (document.getElementById('featured_box').checked) 
	{
		$('#page_box').show();
		$('#page_text_box').show();
	}
...
<tr>
<td class="TitleText">
<b>Door Display Page</b>
</td>
</tr>
<tr>
<td class="MainText">
<br><br>
Here's the door you just selected. Make your changes and then click on "submit" at the bottom of the screen.
<ul><li>If you want to feature this door as part of the main menu, put a "check" in the "featured" check box</li>
<li>To prevent the door from being displayed on the site at all, click on the "hidden" box</li>
<li>To discount all of the products that are associated with this door, put a percentage value in the "multiplier" field (10% would be "10")</li>
<li><b>To discount the door as a sample, put a "1" in the "on sale" field and put a sale price in the "sale price" field</b></li></ul>
To return to the Door List, click <a href="door_list.php">here</a>.
<br><br>
...
<td class="admin_body">
	...
	<td class="admin_body">	
		<table width="700" class="center" border="0"><form enctype="multipart/form-data" action="door_edit.php" method="post">
		<tr>
			<td style="background-color:#cccccc; text-align:right;" colspan="2">
				<table align="right">
					<tr>
						...
						<td>
						<input type="text" size="15" name="multiplier" style="display:inline-block;" value="<?php echo $row['multiplier'];?>">
						</td>
						<td>
						<IMG SRC="images/spacer.gif" height="10">
						</td>
						...
						if($featured==0){
						?>
						<input type="checkbox" value="Y" name="featured" id="featured_box" onchange="big_page();">
						<?php
						}
						else
						{
						?>
						<input type="checkbox" value="Y" name="featured" id="featured_box" checked onchange="big_page();">
						<?php
						}
						?>
						</td>
			...
			{ 
			?>
			<tr id="page_box" style="display:none;">
			<?php
			}
			else
			{
			...
			?>
				<td colspan="2" style="background-color:#000000; color:#ffffff; text-align:right;">...featured door page&nbsp;</td>
			</tr>
			<?php if($featured==0) 
			{ 
			?>
			<tr id="page_text_box" style="display:none;">
			<?php
			}
			else
			{
			...
			?>
				<td colspan="2"><textarea name="page"><?php echo stripslashes($row['page']); ?></textarea></td>
			</tr>
			<tr>
				...
				{
				?>
				<A HREF="../assets/images/door_colors/<?php echo $image1; ?>" target="_blank">Photo</a>
				<?php
				}
				else
				{
			...
			<tr>
				...
				<td background="../images/spacer.gif" width="500" height="10">
				<input type="text" size="80" name="metatags" value="<?php echo $row['metatags']; ?>">
				</td>
			</tr>
			<tr>
