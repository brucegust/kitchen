...
$featured_contestant = "UPDATE doors SET featured='1' where id='$_POST[ID]'";
...
$featured_contestant = "UPDATE doors SET featured='0' where id='$_POST[ID]'";
$featured_contestant_result = mysqli_query($cxn, $featured_contestant);
}
...
$shy=1;
//here's where I'm checking to see if the featured box is checked and if it is, I update with a "Y" value
$featured_contestant = "UPDATE doors SET hidden='1' where id='$_POST[ID]'";
$featured_contestant_result = mysqli_query($cxn, $featured_contestant);
}
else
{
$shy=0;
//just in case it had been populated before, we go ahead and update it to a null value so we can remove the featured option if need be
$featured_contestant = "UPDATE doors SET hidden='0' where id='$_POST[ID]'";
$featured_contestant_result = mysqli_query($cxn, $featured_contestant);
}

if(isset($_POST['multiplier'])&&trim($_POST['multiplier'])<>"")
{
	$the_multiplier=trim($_POST['multiplier']);
	$sql="update doors set multiplier='$the_multiplier' where id='$_POST[ID]'";
...
$query = "UPDATE doors SET name='$name',
part_id='$part_id',
mfgid='$mfgid',
...
$photo_presence=1;
echo $photo_presence;
require_once('door_photo_edit_script.php');
} 

$bruce= "select image1 from doors where id = '$_POST[ID]'";
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>
		<td class="MainText">
		<P>
		Here's the door you just edited. To make any addtional changes, click on the "Back" button of your browser and repeat the process. Otherwise, to return to the Door List, click <A HREF="door_list.php">here</a>.
		<br><br>
	...
	<tr>
		<td align="center">
					...
					<td style="background-color:#cccccc; text-align:right;" colspan="2">
						<table align="right">
							<tr>
								...
								<td>
								<input type="text" size="15" name="multiplier" style="display:inline-block;" value="<?php echo $_POST['multiplier'];?>">
								</td>
								<td>
								<IMG SRC="images/spacer.gif" height="10">
								</td>
			...
			<tr id="page_box"  <?php if(!$flag>0) { ?>style="display:none;"><?php } else { ?>><?php }?>
				<td colspan="2"><textarea name="page"><?php echo $_POST['page']; ?></textarea></td>
			</tr>
			<tr>
				<?php 
				if($photo_there>0)
				...
				<tr>
					...
					<a href="../assets/images/door_colors/<?php echo $image1; ?>" target="_blank" style="color:#000000;">Photo
					</td>
				</tr>
				<?php
				}
