...
$insert = "insert into photos (name, description, url)
...
<td class="MainText">
<P>
Here's the staff member you just entered into the database. To make any changes, click <A HREF="photoList.php">here</a>, or to add another staff member, click <A HREF="photoInsert.php">here</a>.
<P>
