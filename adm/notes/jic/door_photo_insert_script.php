...
$target = "../assets/images/door_colors/"; 
...
$michelle = "update doors set image1='$url' where id = '$novie_id'";
...
$width = 160;  // pixels
$height = 100;   // pixels 
$newFilePath = '../assets/images/door_colors/thumbs/';
$imageFolder = '../assets/images/door_colors/';
