...
$bruce="select * from photos where id='$_POST[ID]'";
...
<td class="admin_body">
	...
	<tr>
	<td>	
	Congratulations! You have successfully deleted your selection from the database. Click <A HREF="photoList.php">here</a> to return to the Staff List.
	<P>
