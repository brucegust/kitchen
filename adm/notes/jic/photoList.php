...
<td class="MainText">
<P>
Below is the list of all the staff members that have been entered into the database. To either edit or delete an entry, simply click on one of the two links located at the bottom of each bio.
<P>
...
<td class="admin_body">
	...
	<td class="admin_body">
		<?php	
		$querystate = "select * from photos order by sort_order ASC";
		...
		<A HREF="photodisplay.php?ID=<?php echo "$id"; ?>&Edit=Yes"><font color="white">Edit</font></a>&nbsp;&nbsp;&nbsp;
		<A HREF="photodisplay.php?ID=<?php echo "$id"; ?>&Delete=Yes"><font color="white">Delete</font>
		</td>
		</tr>
		</table>&nbsp;<BR>
		<?php
