...
$insert = "insert into articles (page_name, body, article_type)
values ('$headline', '$bigstory', 'plain_text')";
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
		...
		<td>
			...
			<td class="MainText">
			<P>
			Here's the text you just entered into the database. To make any changes, click <A HREF="article_list.php">here</a>, or to add another search, click <A HREF="article_insert.php">here</a>.
			<P>
