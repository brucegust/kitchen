...
$insert = "insert into calendar_design (month, number_days, month_number, starting_day, year)
values ('$month', '$days','$month_number', '$starting_day', '$year')";
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
		...
		<td>
			...
			<td class="MainText">
			<P>
			Here's the month you just entered into the database. To make any changes, click <A HREF="cal_design_list.php">here</a>, or to add another month, click <A HREF="cal_design_insert.php">here</a>.
			<P>
