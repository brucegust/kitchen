...
<td class="MainText">
<ul>
<li>select the students who you want to authorize to view the <b><?php echo stripslashes($jorja_row['name']).' | '.stripslashes($jorja_row['rank']); ?></b></li>
...
<td>
	...
	{
	$suzi="select id from video_assign where id='$_GET[video_id]' and student_id='$scott_row[id]'";
