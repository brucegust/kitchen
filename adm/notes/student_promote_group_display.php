...
$rank_id=$_POST['video_belt'];
$class_name = $_POST['video_class'];
$next_rank=$_POST['videos'];

$scott="select s.first_name, s.last_name, s.id as student_id, s.rank, c.name as class_name, r.rank as belt_name from students s 
...
$francis = "select rank from ranks where id='$next_rank'";
...
<td class="MainText">
<ul>
<li>select the students who you want to promote to <b><?php echo stripslashes($francis_row['rank']); ?></b></li>
<li>click on the "submit" button below</li><ul>	
</td>
</tr>
<tr>
<td>
To return to the admin page, click <A HREF="admin.php">here</a>. Or, to return to the Student Group Promotion Page, click <A HREF="student_promote.php">here</a>.
<P>
...
<td>
	...
	<?php
	$bruce="select id, rank from students where id='$student_id' and rank='$next_rank'";
...
<input type="hidden" name="rank" value="<?php echo $next_rank; ?>">
