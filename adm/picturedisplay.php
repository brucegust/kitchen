...
{
$ID=$_GET['ID'];
header("Location: picturedelete.php?ID=$ID");
}
else
{
$cxn = mysqli_connect($host,$user,$password,$database)
or die ("couldn't connect to server");
$query = "select * from pictures where id = '$_GET[ID]'";
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>
		<td class="MainText">
		<P>
		Here's the photo you just selected. Change whatever information you need to alter and then click on "Submit." To return to the Photo List, click <A HREF="pictureList.php">here</a>.
		<P>
	...
	<tr>
		<td class="admin_body">
			<table class="center" border="0"><form action="pictureedit.php" method="Post">
				<tr>
