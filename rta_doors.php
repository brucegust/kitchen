...
?>
		...
		<?php
		$bruce = "select * from pages where page_name='rta_door_colors'";
				...
				<td style="text-align:center;">
					<table border="0" style="margin:auto;">
						...
						<tr>
							...
							<b><?php echo stripslashes($display['title']); ?></b><br><A HREF="door_samples.php?id=<?php echo $display['id']; ?>" style="color:#000000; text-decoration:none;">more info...</a><br><br><br>
							</td>
						</tr>
					</table>
				<?php
